                    ...
                    <div class="layui-col-md3">
                      <validation-provider name="catalog" rules="is_not:请选择" v-slot="{errors}">
                        <div class="layui-row">
                          ...
                          <div class="layui-input-block" @click="toggleSelect()">
                            <div class="layui-unselect layui-form-select" :class="{'layui-form-selected': isSelected_catalog}">
                              <div class="layui-form-title">
                                ...
                                <dl class="layui-anim layui-anim-upbit">
                                  <dd v-for="(item, index) in catalogs" :key="'catalog' + index" :value="item.value" :class="{'layui-this': index === cataIndex}" @click="chooseCatalog(item, index)">{{item.text}}</dd>
                                </dl>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="layui-inline">
                      ...
                      <div class="layui-input-inline" style="width: 190px;">
                        <div
                          ...
                          :class="{'layui-form-selected': isSelected_fav}"
                          @click="changeFav()"
                        >
...
export default {
  ...
  data() {
    return {
      cataIndex: 0, // 帖子类型
      favIndex: 0, // 积分标识
      isSelected_catalog: false,
      isSelected_fav: false,
      title: '',
      cataObj: {
        catalogs: '',
        title: ''
  ...
  methods: {
    ...
    toggleSelect() {
      this.isSelected_catalog = !this.isSelected_catalog
    },
    changeFav() {
      this.isSelected_fav = !this.isSelected_fav
    },
